...
### 9.4 Kvarstående Förbättringsområden (Validerade via Demo 2025-12-01)

| Problem | Status | EPIC | Beskrivning |
|---------|--------|------|-------------|
| Minnesförlust (takpris) | 🔴 Kritisk | EPIC-431 | Botten glömmer redan angivna värden |
| Geo-data (Härnösand) | 🔴 Kritisk | EPIC-430 | Felaktig koppling av anbudsområde |
| Fyrkantig guidning | 🟡 Hög | EPIC-432 | Saknar proaktiv guidning mot Exempelroller |
| Varukorg-sync | 🟡 Hög | EPIC-433 | SummaryCard uppdateras inte vid rolltolkning |
| Begränsade viktningsval | 🟢 Låg | EPIC-420 | Användare vill ha 60/40, inte bara 50/50 |

### 9.5 Validerade Funktioner (Demo 2025-12-01)

| Funktion | Status | Beskrivning |
|----------|--------|-------------|
| Regelhantering | ✅ Godkänd | Spärr mot blandade kompetensområden fungerar |
| Logisk validering | ✅ Godkänd | Orimliga inmatningar (t.ex. startdatum bakåt) avvisas |
| KN5→FKU regel | ✅ Godkänd | Tvingar FKU vid nivå 5 |
